...
import { normalizeGraph, reprojectNodesFromGPS } from '../src/state/normalize.ts'
import type { MutableNode } from '../src/state/normalize.ts'
import { enforceEdgeOnlyNodeType } from '../src/state/graph-rules.ts'
...
test('reprojectNodesFromGPS fills missing coordinates when GPS locked', () => {
  const nodes: MutableNode[] = [
    { id: 'n1', type: 'OUVRAGE', gps_lat: 45, gps_lon: 3, gps_locked: true, x: null, y: null } as MutableNode,
  ]
